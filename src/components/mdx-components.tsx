...
const components = {
  ...
  h2: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => <h2 className={cn('font-heading mt-12 scroll-m-20 pb-2 text-2xl font-semibold tracking-tight first:mt-0', linkRightOfHeaderClassName, className)} {...props} />,
  h3: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => <h3 className={cn('font-heading mt-8 scroll-m-20 text-xl font-semibold tracking-tight', linkRightOfHeaderClassName, className)} {...props} />,
  h4: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => <h4 className={cn('font-heading mt-8 scroll-m-20 text-lg font-semibold tracking-tight', linkRightOfHeaderClassName, className)} {...props} />,
  h5: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => <h5 className={cn('mt-8 scroll-m-20 text-lg font-semibold tracking-tight', linkRightOfHeaderClassName, className)} {...props} />,
  h6: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => <h6 className={cn('mt-8 scroll-m-20 text-base font-semibold tracking-tight', linkRightOfHeaderClassName, className)} {...props} />,
