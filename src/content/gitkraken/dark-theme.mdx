---
title: GitKraken Dark Knight Theme
description: My custom dark theme for GitKraken.
kind: 'theme'
---

## Usage

1. Insatll [GitKraken](https://www.gitkraken.com/).
...
5. Create a new file named ending in `.jsonc`. For example (`MyCustomTheme.jsonc` or `Dark Knight.jsonc`) and paste in the content below.
   ...
   ```json title="Users/{yourUserName}/.gitkraken/{yourThemeName}.jsonc"
   {
     "meta": {
       "name": "Dark Knight",
